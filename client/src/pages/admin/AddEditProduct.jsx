...
export default function AddEditProduct() {
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 md:px-6 py-8">
      ...
      {!isEdit && fdaLoading && (
        <div className="bg-teal-50/50 border border-teal-100 rounded-xl p-4 mb-6 flex items-center gap-3">
      ...
      {!isEdit && fdaSuggestion && !hideFda && (
        <div className="bg-teal-50 border border-teal-150 rounded-xl p-5 mb-6 animate-fadeIn shadow-xs">
          <div className="flex items-start justify-between gap-4">
            <div className="flex items-start gap-3">
              <Sparkles className="w-5 h-5 text-teal-600 shrink-0 mt-0.5" />
              <div>
                <h4 className="text-sm font-extrabold text-teal-900">OpenFDA Active Ingredient Suggestion</h4>
                <p className="text-xs text-gray-500 mt-0.5">
                  We found matching active components for <span className="font-bold text-teal-800">"{watchName}"</span>.
                </p>
                <div className="bg-white border border-teal-100/50 rounded-lg py-2 px-3.5 mt-3 text-sm font-semibold text-teal-950">
                  {fdaSuggestion}
                </div>
              </div>
            </div>
          ...
          <div className="flex gap-2.5 mt-4 justify-end">
            ...
            <button
              ...
              className="btn-teal py-1.5 px-4 text-xs font-bold flex items-center gap-1"
            >
      ...
      <form onSubmit={handleSubmit(onFormSubmit)} className="space-y-6">
        ...
        <div className="bg-white border border-gray-200 rounded-xl p-6 shadow-xs space-y-4">
          <h3 className="text-sm font-extrabold text-teal-900 border-b border-gray-100 pb-2">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              ...
              <input
                ...
                className={`w-full px-3 py-2 border rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-teal-500/20 ${
                  errors.name ? 'border-red-400 focus:border-red-500' : 'border-gray-300 focus:border-teal-500'
                }`}
              />
              {errors.name && (
            ...
            <div>
              ...
              <input
                ...
                className={`w-full px-3 py-2 border rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-teal-500/20 ${
                  errors.brand ? 'border-red-400 focus:border-red-500' : 'border-gray-300 focus:border-teal-500'
                }`}
              />
              {errors.brand && (
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div>
              ...
              <input
                ...
                placeholder="0.00"
                className={`w-full px-3 py-2 border rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-teal-500/20 ${
                  errors.mrp ? 'border-red-400 focus:border-red-500' : 'border-gray-300 focus:border-teal-500'
                }`}
              />
              {errors.mrp && (
            ...
            <div>
              ...
              <input
                ...
                placeholder="0.00"
                className={`w-full px-3 py-2 border rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-teal-500/20 ${
                  errors.sellingPrice ? 'border-red-400 focus:border-red-500' : 'border-gray-300 focus:border-teal-500'
                }`}
              />
              {errors.sellingPrice && (
            ...
            <div>
              ...
              <input
                ...
                placeholder="0"
                className={`w-full px-3 py-2 border rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-teal-500/20 ${
                  errors.stock ? 'border-red-400 focus:border-red-500' : 'border-gray-300 focus:border-teal-500'
                }`}
              />
              {errors.stock && (
          ...
          <div className="border-t border-gray-100 pt-4">
            ...
            <div className="relative">
              <input
                ...
                className="w-full pl-9 pr-9 py-2 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-teal-500/20 focus:border-teal-500"
              />
                ...
                <div className="absolute left-0 right-0 top-full mt-1.5 bg-white border border-gray-200 rounded-lg shadow-lg max-h-52 overflow-y-auto z-40 divide-y divide-gray-100">
                  {subResults.map((medicine) => (
                    ...
                    >
                      ...
                      <span className="text-[10px] font-bold text-teal-800 bg-teal-50 px-2 py-0.5 border border-teal-100 rounded-full">
                        Add Alternate
                      </span>
                    </div>
                  ))}
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <textarea
                ...
                className="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-teal-500/20 focus:border-teal-500 resize-y"
              />
            </div>
        ...
        <div className="flex justify-end gap-3 pt-2">
          ...
          <button
            type="submit"
            disabled={loading}
            className="btn-teal py-2.5 px-6 font-semibold flex items-center justify-center gap-1.5 shadow-xs"
          >
            {loading ? (
              <>
